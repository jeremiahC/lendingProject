            ...
            <div class="card blue accent-1 white-text">
                <div class="card-content">
                    ...
                    <div class="center-align">
                        <input type="text" value="{{$id->customer_id}}" id="customer_id" name="customer_id" hidden/>
    ...
    <div class="row">
        <div class=" col s12 m6 l6">
                ...
                <div class="card-content">
                    @if(empty($id->amount))
                        <div class="grey lighten-3" style="padding:10px;">
                            <a class="btn-floating btn-medium waves-effect waves-light light-green lighten-3 " href="/investments/approve/{{$id->id}}">
            ...
            @if(!empty($id->amount))
                <!-- Dropdown Trigger -->
                    @if($id->amount->approved === null)
                        <a class='dropdown-button btn right red' href='#' data-activates='useroptions'>Options</a>
