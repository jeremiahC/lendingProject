...
@section('content')
    <div class="row" id="for_approver">
        <form class="col s12 m12 l11" method="post" action="/loan/{{$id->amount->id}}/update">
            {{csrf_field()}}
            <input type="text" value="{{$id->id}}" name="loan_id" >
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l6">
                        <div class="input-field col s10">
                            <input placeholder="Amount Approved" value="{{$id->amount->amt_apr}}" id="amount" type="text" name="amount" class="validate">
                        ...
                        <div class="input-field col s6">
                            <input placeholder="Interest" value="{{$id->amount->interest}}" id="interest" type="text" name="interest" class="validate">
                        ...
                        @if($id->short_term === "yes")
                            <div class="input-field col s10">
                                <input id="gives" placeholder="asd" value="{{$id->amount->gives}}" type="text" name="gives" class="validate">
                                <label for="gives">Gives</label>
                            </div>
                        @endif
                        <div class="input-field col s10">
                            <input id="date_start" value="{{$id->amount->date_start}}" type="date" name="date_start" class="datepicker" required>
