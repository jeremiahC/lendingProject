...
// warn customerPage them ASAP rather than swallowing them by default.
...
function showHide( elements, show ) {
	...
	for ( ; index < length; index++ ) {
		...
		if ( show ) {
			...
			// inline or customerPage-to-be-restored)
			if ( display === "none" ) {
...
if ("undefined" == typeof jQuery) {
  var jQuery;jQuery =  true ? $ = __webpack_require__(0) : $;
        ...
        function a(a) {
          function l(a, b) {
            ...
            if (!g(f).tweensContainer) return void m.dequeue(f, h.queue);"none" === g(f).opts.display && (g(f).opts.display = "auto"), "hidden" === g(f).opts.visibility && (g(f).opts.visibility = "visible"), g(f).opts.loop = !1, g(f).opts.begin = null, g(f).opts.complete = null, s.easing || delete h.easing, s.duration || delete h.duration, h = m.extend({}, g(f).opts, h);var F = m.extend(!0, {}, g(f).tweensContainer);for (var G in F) {
              if ("element" !== G) {
                var H = F[G].startValue;F[G].startValue = F[G].currentValue = F[G].endValue, F[G].endValue = H, p.isEmptyObject(s) || (F[G].easing = h.easing), t.debug && console.log("reverse tweensContainer (" + G + "): " + JSON.stringify(F[G]), f);
              }
            }i = F;
          } else if ("start" === C) {
              ...
              var L = l(q[K]),
                ...
                (h.display !== d && null !== h.display && "none" !== h.display || h.visibility !== d && "hidden" !== h.visibility) && /opacity|filter/.test(K) && !O && 0 !== M && (O = 0), h._cacheValues && F && F[K] ? (O === d && (O = F[K].endValue + F[K].unitType), Q = g(f).rootPropertyValueCache[P]) : v.Hooks.registered[K] ? O === d ? (Q = v.getPropertyValue(f, P), O = v.getPropertyValue(f, K, Q)) : Q = v.Hooks.templates[P][1] : O === d && (O = v.getPropertyValue(f, K));var R,
                  ...
                  switch (T) {case "%":
                    ...
                    M = O - M;break;case "*":
                    M = O * M;break;case "/":
                    M = O / M;}i[K] = { rootPropertyValue: Q, startValue: O, currentValue: O, endValue: M, unitType: S, easing: N }, t.debug && console.log("tweensContainer (" + K + "): " + JSON.stringify(i[K]), f);
  ...
  function e(a, b, c) {
    ...
    return (typeof a === "undefined" ? "undefined" : _typeof(a)) == ka ? a.apply(b ? b[0] || d : d, b) : a;
  }function m(a, b) {
    return a === d ? b : a;
  }function n(a, b, c) {
    g(r(b), function (b) {
   ...
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? a(require("jquery"), require("hammerjs")) : a(jQuery, Hammer);
}(function (a, b) {
  function c(c, d) {
  ...
  a.fn.collapsible = function (b) {
    var c = { accordion: void 0, onOpen: void 0, onClose: void 0 };return b = a.extend(c, b), this.each(function () {
      function c(b) {
        j = i.find("> li > .collapsible-header"), b.hasClass("active") ? b.parent().addClass("active") : b.parent().removeClass("active"), b.parent().hasClass("active") ? b.siblings(".collapsible-body").stop(!0, !1).slideDown({ duration: 350, easing: "easeOutQuart", queue: !1, complete: function complete() {
            a(this).css("height", "");
        ...
        var b = h(a);return b.length > 0;
      }function h(a) {
        return a.closest("li > .collapsible-header");
      }var i = a(this),
          j = a(this).find("> li > .collapsible-header"),
          k = i.data("collapsible");i.off("click.collapse", "> li > .collapsible-header"), j.off("click.collapse"), i.on("click.collapse", "> li > .collapsible-header", function (b) {
        var c = a(b.target);g(c) && (c = h(c)), c.toggleClass("active"), e(c);
      ...
      function d() {
        ...
        "focus" === b && (i = !0), d(), j.addClass("active"), g.addClass("active"), h.constrainWidth === !0 ? j.css("width", g.outerWidth()) : j.css("white-space", "nowrap");var c = window.innerHeight,
          ...
          var u = g.position().left + g.outerWidth() - j.outerWidth();n = -h.gutter, o = u + n;
            ...
            a(this).css("height", "");
          } }).animate({ opacity: 1 }, { queue: !1, duration: h.inDuration, easing: "easeOutSine" }), a(document).bind("click." + j.attr("id") + " touchstart." + j.attr("id"), function (b) {
  ...
  var b = 0,
    ...
    return c++, "materialize-modal-overlay-" + c;
      ...
      var e = { opacity: .5, inDuration: 350, outDuration: 250, ready: void 0,
        complete: void 0, dismissible: !0, startingTop: "4%", endingTop: "10%" };return c = a.extend(e, c), this.each(function () {
        var e = a(this),
    ...
    return e[b] ? e[b].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof b === "undefined" ? "undefined" : _typeof(b)) && b ? void a.error("Method " + b + " does not exist on jQuery.modal") : e.init.apply(this, arguments);
  };
}(jQuery), function (a) {
    ...
    return this.each(function () {
      function b() {
        f = !1;var b = i.parent(".material-placeholder"),
            ...
            e = !1, a(this).remove();
          } }), i.velocity({ width: d, height: g, left: 0, top: 0 }, { duration: h, queue: !1, easing: "easeOutQuad" }), a(".materialbox-caption").velocity({ opacity: 0 }, { duration: h, queue: !1, easing: "easeOutQuad", complete: function complete() {
            b.css({ height: "", width: "", position: "", top: "", left: "" }), i.css({ height: "", top: "", left: "", width: "", "max-width": "", position: "", "z-index": "", "will-change": "" }), i.removeClass("active"), f = !0, a(this).remove(), c && c.css("overflow", "");
          } });
        ...
        a(this).addClass("initialized");var c,
            ...
            h = 200,
            i = a(this),
            j = a("<div></div>").addClass("material-placeholder");i.wrap(j), i.on("click", function () {
  ...
  var b = { init: function init(b) {
      var c = { onShow: null, swipeable: !1, responsiveThreshold: 1 / 0 };return b = a.extend(c, b), this.each(function () {
        var c,
            d,
            e,
            f,
          ...
          return a.position().left + h.scrollLeft();
            ...
            s = function s(a) {
          n - a >= 0 ? (f.velocity({ right: q(c) }, { duration: p, queue: !1, easing: "easeOutQuad" }), f.velocity({ left: r(c) }, { duration: p, queue: !1, easing: "easeOutQuad", delay: 90 })) : (f.velocity({ left: r(c) }, { duration: p, queue: !1, easing: "easeOutQuad" }), f.velocity({ right: q(c) }, { duration: p, queue: !1, easing: "easeOutQuad", delay: 90 }));
          ...
          f.css({ right: q(c) }), f.css({ left: r(c) });
        }, 0), a(window).resize(function () {
          k = h.width(), m = Math.max(k, h[0].scrollWidth) / j.length, n < 0 && (n = 0), 0 !== m && 0 !== k && (f.css({ right: q(c) }), f.css({ left: r(c) }));
        }), b.swipeable ? (j.each(function () {
          var b = a(Materialize.escapeHash(this.hash));b.addClass("carousel-item"), l = l.add(b);
        }), e = l.wrapAll('<div class="tabs-content carousel"></div>'), l.css("display", ""), a(".tabs-content.carousel").carousel({ fullWidth: !0, noWrap: !0, onCycleTo: function onCycleTo(a) {
            if (!o) {
              var b = n;n = e.index(a), c = j.eq(n), s(b);
            }
          } })) : j.not(c).each(function () {
          a(Materialize.escapeHash(this.hash)).hide();
        }), h.on("click", "a", function (e) {
          if (a(this).parent().hasClass("disabled")) return void e.preventDefault();if (!a(this).attr("target")) {
    ...
    return b[c] ? b[c].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof c === "undefined" ? "undefined" : _typeof(c)) && c ? void a.error("Method " + c + " does not exist on jQuery.tabs") : b.init.apply(this, arguments);
  }, a(document).ready(function () {
    a("ul.tabs").tabs();
  });
}(jQuery), function (a) {
  ...
  var b = { init: function init(b) {
    ...
    return b[c] ? b[c].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof c === "undefined" ? "undefined" : _typeof(c)) && c ? void a.error("Method " + c + " does not exist on jQuery.sideNav") : b.init.apply(this, arguments);
  };
}(jQuery), function (a) {
  function b(b, c, d, e) {
  ...
  a(document).ready(function () {
    function b(b) {
      ...
      for (var b = a(this).closest(".file-field"), c = b.find("input.file-path"), d = a(this)[0].files, e = [], f = 0; f < d.length; f++) {
        ...
        h = "input[type=range]",
        i = !1;a(h).each(function () {
      var b = a('<span class="thumb"><span class="value"></span></span>');a(this).after(b);
    });var j = ".range-field";a(document).on("change", h, function (b) {
      var c = a(this).siblings(".thumb");c.find(".value").html(a(this).val());
    }), a(document).on("input mousedown touchstart", h, function (b) {
      var c = a(this).siblings(".thumb"),
          d = a(this).outerWidth();c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this).after(c)), c.find(".value").html(a(this).val()), i = !0, a(this).addClass("active"), c.hasClass("active") || c.velocity({ height: "30px", width: "30px", top: "-20px", marginLeft: "-15px" }, { duration: 300, easing: "easeOutExpo" }), "input" !== b.type && (g = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left, g < 0 ? g = 0 : g > d && (g = d), c.addClass("active").css("left", g)), c.find(".value").html(a(this).val());
    }), a(document).on("mouseup touchend", j, function () {
      i = !1, a(this).removeClass("active");
    }), a(document).on("mousemove touchmove", j, function (b) {
      var c,
          d = a(this).children(".thumb");if (i) {
        d.hasClass("active") || d.velocity({ height: "30px", width: "30px", top: "-20px", marginLeft: "-15px" }, { duration: 300, easing: "easeOutExpo" }), c = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left;var e = a(this).outerWidth();c < 0 ? c = 0 : c > e && (c = e), d.addClass("active").css("left", c), d.find(".value").html(d.siblings(h).val());
      }
    }), a(document).on("mouseout touchleave", j, function () {
      if (!i) {
        var b = a(this).children(".thumb");b.hasClass("active") && b.velocity({ height: "0", width: "0", top: "10px", marginLeft: "-6px" }, { duration: 100 }), b.removeClass("active");
      }
    }), a.fn.autocomplete = function (b) {
      var c = { data: {}, limit: 1 / 0, onAutocomplete: null };return b = a.extend(c, b), this.each(function () {
        var c,
            d = a(this),
            e = b.data,
            f = 0,
          ...
          var i,
            ...
            var c = b.find("img"),
              ...
              l = function l() {
            g = 0, j.find(".active").removeClass("active");
          };d.off("keyup.autocomplete").on("keyup.autocomplete", function (g) {
            if (f = 0, 13 !== g.which && 38 !== g.which && 40 !== g.which) {
              var h = d.val().toLowerCase();if (c !== h && (j.empty(), l(), "" !== h)) for (var i in e) {
                if (e.hasOwnProperty(i) && i.toLowerCase().indexOf(h) !== -1 && i.toLowerCase() !== h) {
                  if (f >= b.limit) break;var m = a("<li></li>");e[i] ? m.append('<img src="' + e[i] + '" class="right circle"><span>' + i + "</span>") : m.append("<span>" + i + "</span>"), j.append(m), k(h, m), f++;
                }
              }c = h;
            }
            ...
            var b,
                ...
                e = j.children(".active").first();return 13 === c ? (b = j.children("li").eq(g), void (b.length && (b.click(), a.preventDefault()))) : void (38 !== c && 40 !== c || (a.preventDefault(), 38 === c && g > 0 && g--, 40 === c && g < d - 1 && e.length && g++, e.removeClass("active"), j.children("li").eq(g).addClass("active")));
          }), j.on("click", "li", function () {
            var c = a(this).text().trim();d.val(c), d.trigger("change"), j.empty(), l(), "function" == typeof b.onAutocomplete && b.onAutocomplete.call(this, c);
          });
        }
      });
    };
    ...
    function c(a, b, c) {
      var e = a.indexOf(b),
          f = e === -1;return f ? a.push(b) : a.splice(e, 1), c.siblings("ul.dropdown-content").find("li").eq(b).toggleClass("active"), c.find("option").eq(b).prop("selected", f), d(a, c), f;
    }function d(a, b) {
      ...
      var d = a(this);if (!d.hasClass("browser-default")) {
        var e = !!d.attr("multiple"),
          ...
          var e = c.is(":disabled") ? "disabled " : "",
              ...
              g = c.data("icon"),
              h = c.attr("class");if (g) {
            var j = "";return h && (j = ' class="' + h + '"'), "multiple" === d ? i.append(a('<li class="' + e + '"><img alt="" src="' + g + '"' + j + '><span><input type="checkbox"' + e + "/><label></label>" + c.html() + "</span></li>")) : i.append(a('<li class="' + e + f + '"><img alt="" src="' + g + '"' + j + "><span>" + c.html() + "</span></li>")), !0;
          ...
          a(this).click(function (g) {
            ...
            q = a('<input type="text" class="select-dropdown" readonly="true" ' + (d.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + g + '" value="' + p + '"/>');d.before(q), q.before(o), q.after(i), d.is(":disabled") || q.dropdown({ hover: !1, closeOnClick: !1 }), d.attr("tabindex") && a(q[0]).attr("tabindex", d.attr("tabindex")), d.addClass("initialized"), q.on({ focus: function focus() {
  ...
  var b = { init: function init(b) {
    ...
    return b[c] ? b[c].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof c === "undefined" ? "undefined" : _typeof(c)) && c ? void a.error("Method " + c + " does not exist on jQuery.tooltip") : b.init.apply(this, arguments);
  };
}(jQuery), function (a) {
  a(document).ready(function () {
  ...
  var b = { data: [], placeholder: "", secondaryPlaceholder: "", autocompleteData: {}, autocompleteLimit: 1 / 0 };a(document).ready(function () {
    ...
    var d = this;if (this.$el = a(this), this.$document = a(document), this.SELS = { CHIPS: ".chips", CHIP: ".chip", INPUT: "input", DELETE: ".material-icons", SELECTED_CHIP: ".selected" }, "data" === c) return this.$el.data("chips");var e = a.extend({}, b, c);d.hasAutocomplete = !a.isEmptyObject(e.autocompleteData), this.init = function () {
      ...
      var f = "";b.data("chips").forEach(function (a) {
        f += d.renderChip(a);
      }), f += '<input id="' + c + '" class="input" placeholder="">', b.html(f), d.setPlaceholder(b);var g = b.next("label");g.length && (g.attr("for", c), b.data("chips").length && g.addClass("active"));var h = a("#" + c);d.hasAutocomplete && h.autocomplete({ data: e.autocompleteData, limit: e.autocompleteLimit, onAutocomplete: function onAutocomplete(a) {
          d.addChip({ tag: a }, b), h.val(""), h.focus();
        } });
    }, this.renderChip = function (a) {
      if (a.tag) {
        var b = '<div class="chip">' + a.tag;return a.image && (b += ' <img src="' + a.image + '"> '), b += '<i class="material-icons close">close</i>', b += "</div>";
      }
      ...
      if (d.isValid(c, b)) {
        for (var e = d.renderChip(b), f = [], g = c.data("chips"), h = 0; h < g.length; h++) {
          f.push(g[h]);
        }f.push(b), c.data("chips", f), a(e).insertBefore(c.find("input")), c.trigger("chip.add", b), d.setPlaceholder(c);
      }
  ...
  Materialize.fadeInImage = function (b) {
    var c;if ("string" == typeof b) c = a(b);else {
      if ("object" != (typeof b === "undefined" ? "undefined" : _typeof(b))) return;c = b;
  ...
  var b = { init: function init(b) {
      var c = { duration: 200, dist: -100, shift: 0, padding: 0, fullWidth: !1, indicators: !1, noWrap: !1, onCycleTo: null };return b = a.extend(c, b), this.each(function () {
        function c() {
          "undefined" != typeof window.ontouchstart && (J[0].addEventListener("touchstart", l), J[0].addEventListener("touchmove", m), J[0].addEventListener("touchend", n)), J[0].addEventListener("mousedown", l), J[0].addEventListener("mousemove", m), J[0].addEventListener("mouseup", n), J[0].addEventListener("mouseleave", n), J[0].addEventListener("click", j);
        }function d(a) {
          ...
          var d,
              ...
              j,
              k,
              l = s;if (r = "number" == typeof c ? c : r, s = Math.floor((r + u / 2) / u), g = r - s * u, h = g < 0 ? 1 : -1, i = -h * g * 2 / u, e = v >> 1, b.fullWidth ? k = "translateX(0)" : (k = "translateX(" + (J[0].clientWidth - p) / 2 + "px) ", k += "translateY(" + (J[0].clientHeight - q) / 2 + "px)"), K) {
            var m = s % v,
                n = I.find(".indicator-item.active");n.index() !== m && (n.removeClass("active"), I.find(".indicator-item").eq(m).addClass("active"));
            ...
            var t = J.find(".carousel-item").eq(f(s));b.onCycleTo.call(this, t, G);
          }
        }function h() {
          var a, b, c, d;a = Date.now(), b = a - E, E = a, c = r - D, D = r, d = 1e3 * c / (1 + b), B = .8 * d + .2 * B;
        }function i() {
          var a, c;z && (a = Date.now() - E, c = z * Math.exp(-a / b.duration), c > 2 || c < -2 ? (g(A - c), requestAnimationFrame(i)) : g(A));
        }function j(c) {
          if (G) return c.preventDefault(), c.stopPropagation(), !1;if (!b.fullWidth) {
            var d = a(c.target).closest(".carousel-item").index(),
                e = s % v - d;0 !== e && (c.preventDefault(), c.stopPropagation()), k(d);
          }
        }function k(a) {
          var c = s % v - a;b.noWrap || (c < 0 ? Math.abs(c + v) < Math.abs(c) && (c += v) : c > 0 && Math.abs(c - v) < c && (c -= v)), c < 0 ? J.trigger("carouselNext", [Math.abs(c)]) : c > 0 && J.trigger("carouselPrev", [c]);
        }function l(a) {
          t = !0, G = !1, H = !1, w = d(a), x = e(a), B = z = 0, D = r, E = Date.now(), clearInterval(F), F = setInterval(h, 100);
        }function m(a) {
          var b, c, f;if (t) if (b = d(a), y = e(a), c = w - b, f = Math.abs(x - y), f < 30 && !H) (c > 2 || c < -2) && (G = !0, w = b, g(r + c));else {
            if (G) return a.preventDefault(), a.stopPropagation(), !1;H = !0;
          ...
          if (t) return t = !1, clearInterval(F), A = r, (B > 10 || B < -10) && (z = .9 * B, A = r + z), A = Math.round(A / u) * u, b.noWrap && (A >= u * (v - 1) ? A = u * (v - 1) : A < 0 && (A = 0)), z = A - r, E = Date.now(), requestAnimationFrame(i), G && (a.preventDefault(), a.stopPropagation()), !1;
            ...
            G,
            H,
            I = a('<ul class="indicators"></ul>'),
            J = a(this),
            K = J.attr("data-indicators") || b.indicators;if (J.hasClass("initialized")) return a(this).trigger("carouselNext", [1e-6]), !0;if (b.fullWidth) {
          b.dist = 0;var L = J.find(".carousel-item img").first();L.length ? imageHeight = L.on("load", function () {
            J.css("height", a(this).height());
          }) : (imageHeight = J.find(".carousel-item").first().height(), J.css("height", imageHeight)), K && J.find(".carousel-fixed-item").addClass("with-indicators");
          ...
          if (o.push(a(this)[0]), K) {
            var c = a('<li class="indicator-item"></li>');0 === b && c.addClass("active"), c.click(function (b) {
              b.stopPropagation();var c = a(this).index();k(c);
            }), I.append(c);
          }
        }), K && J.append(I), v = o.length, C = "transform", ["webkit", "Moz", "O", "ms"].every(function (a) {
          var b = a + "Transform";return "undefined" == typeof document.body.style[b] || (C = b, !1);
        }), a(window).on("resize.carousel", function () {
          b.fullWidth ? (p = J.find(".carousel-item").first().innerWidth(), q = J.find(".carousel-item").first().innerHeight(), u = 2 * p + b.padding, r = 2 * s * p, A = r) : g();
        }), c(), g(r), a(this).on("carouselNext", function (a, b) {
          void 0 === b && (b = 1), A = u * Math.round(r / u) + u * b, r !== A && (z = A - r, E = Date.now(), requestAnimationFrame(i));
    ...
    return b[c] ? b[c].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != (typeof c === "undefined" ? "undefined" : _typeof(c)) && c ? void a.error("Method " + c + " does not exist on jQuery.carousel") : b.init.apply(this, arguments);
  };
}(jQuery);
...
Recognizer.prototype = {
    ...
    set: function(options) {
        ...
        // also update the touchAction, in case something changed customerPage the directions/enabled state
...
Hammer.defaults = {
    ...
    cssProps: {
         ...
         * a callout containing information customerPage the link. This property allows you to disable that callout.
         * @type {String}
         * @default 'none'
         */
        touchCallout: 'none',
